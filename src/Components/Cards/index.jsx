          ...
          <div class="card">
            ...
            <div class="card__content">
              ...
              <p class="card__description">
                Projeto de aplicativo de Pokédex utilizando React Native. O projeto
                foi desenvolvido em grupo e consome a PokéAPI.
              </p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card__content">
              ...
              <p class="card__description">
                Réplica de sistema bancário, com função de cadastro de clientes e diferentes
                níveis de permissões de acorddo com o cargo. Desenvolvido em grupo utilizando Java.
              </p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card__content">
              ...
              <p class="card__description">
                Landing page para servir de portfólio profissional. Desenvolvida individualmente utilizando
                Figma e React.
              </p>
            </div>
          </div>
